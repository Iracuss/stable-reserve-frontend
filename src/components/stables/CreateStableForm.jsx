...
import { createStable } from "../../api/stableService";

export default function CreateStableForm({ onCreate, setIsCreating }) {
    const [name, setName] = useState('');
    const [coggins, setCoggins] = useState(365);
    const [farrier, setFarrier] = useState(42);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const savedStable = await createStable(stable);
            setIsCreating(false);
                ...
                <div className="flex flex-col gap-4">
                    ...
                    <div className="flex gap-6 w-full">
                        ...
                        <div className="flex flex-col gap-2 w-1/2">
                            <label className="text-sm font-semibold text-gray-700 pl-1">
                                Coggins Renewal (Days) <span className="text-red-500">*</span>
                            </label>
                            <input 
                                type="number" 
                                placeholder="365" 
                        ...
                        <div className="flex flex-col gap-2 w-1/2">
                            <label className="text-sm font-semibold text-gray-700 pl-1">
                                Farrier Schedule (Days) <span className="text-red-500">*</span>
                            </label>
                            <input 
                                type="number" 
                                placeholder="42"
